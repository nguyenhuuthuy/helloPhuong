var cardLeft = document.querySelector('.wed-left');
var cardRight = document.querySelector('.wed-right');

cardLeft.style.cursor = 'pointer';
console.log(cardLeft);
cardLeft.onclick = function() {
    cardLeft.style.transform = 'translateX(0px)';
    cardLeft.style.cursor = 'unset';

    cardRight.style.opacity = '1';
    cardRight.style.transform = 'translateX(0px)';
}
